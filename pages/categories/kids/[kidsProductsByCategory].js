...
export default function KidsProductsByCategoryPage({ products }) {
  ...
  const selectedCategory = router.query.kidsProductsByCategory;
  ...
  return (
    <>
      <PageContainer>
        ...
        <ContentWrapper>
          <Center>
            <Title>Kids {selectedCategory} Shoes</Title>
